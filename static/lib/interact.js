...
function add(element, type, listener, useCapture) {
  ...
  if (contains(target.events[type], listener)) { return; }
  ...
  var wrappedListener = wrapped[listenerIndex] || _.throttle(useAttachEvent ? function (event) {
  ...
  } : listener, +localStorage.interactThrottle || -1);
  ...
  return element[addEvent](on + type, wrappedListener, !!useCapture);
}
